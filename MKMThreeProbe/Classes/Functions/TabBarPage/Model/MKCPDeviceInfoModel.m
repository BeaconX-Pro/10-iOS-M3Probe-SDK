...
@implementation MKCPDeviceInfoModel
...
- (BOOL)readBatteryPower {
    ...
    [MKCPInterface cp_readBatteryWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readMacAddress {
    __block BOOL success = NO;
    [MKCPInterface cp_readMacAddresWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readProduce {
    __block BOOL success = NO;
    [MKCPInterface cp_readModeIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readSoftware {
    __block BOOL success = NO;
    [MKCPInterface cp_readSoftwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readFirmware {
    __block BOOL success = NO;
    [MKCPInterface cp_readFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHardware {
    __block BOOL success = NO;
    [MKCPInterface cp_readHardwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readManuDate {
    __block BOOL success = NO;
    [MKCPInterface cp_readProductionDateWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readManu {
    __block BOOL success = NO;
    [MKCPInterface cp_readVendorWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
