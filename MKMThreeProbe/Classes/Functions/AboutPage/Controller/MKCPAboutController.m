...
@implementation MKCPAboutController

- (void)dealloc {
    NSLog(@"MKCPAboutController销毁");
}
...
- (UILabel *)appNameLabel{
    if (!_appNameLabel) {
        ...
        _appNameLabel.text = @"MOKO M3 Probe";
    }
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKMThreeProbe", @"MKCPAboutController", @"cp_aboutIcon.png");
    }
    return _aboutIcon;
}
