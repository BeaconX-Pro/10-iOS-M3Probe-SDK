...
@interface MKCPDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKCPDFUModule

- (void)dealloc{
    NSLog(@"MKCPDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKCPCentralManager shared].peripheral];
}
