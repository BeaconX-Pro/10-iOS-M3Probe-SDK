...
@interface MKCPUpdateController ()<UITableViewDelegate,UITableViewDataSource,UIDocumentPickerDelegate>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKCPDFUModule *dfuModule;
...
@implementation MKCPUpdateController
...
- (void)startDFUWithFilePath:(NSString *)filePath {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_cp_startDfuProcessNotification" object:nil];
...
- (void)updateComplete {
    ...
    [MKCPCentralManager sharedDealloc];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_cp_centralDeallocNotification" object:nil];
...
- (MKCPDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKCPDFUModule alloc] init];
    }
    return _dfuModule;
}
