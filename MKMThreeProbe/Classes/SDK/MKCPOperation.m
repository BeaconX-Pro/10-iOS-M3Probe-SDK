...
/**
 线程ID
 */
@property (nonatomic, assign)mk_cp_taskOperationID operationID;
...
- (instancetype)initOperationWithID:(mk_cp_taskOperationID)operationID
...
- (void)peripheral:(CBPeripheral *)peripheral didUpdateValueForCharacteristic:(CBCharacteristic *)characteristic {
    [self dataParserReceivedData:[MKCPTaskAdopter parseReadDataWithCharacteristic:characteristic]];
}

- (void)peripheral:(CBPeripheral *)peripheral didWriteValueForCharacteristic:(CBCharacteristic *)characteristic {
    [self dataParserReceivedData:[MKCPTaskAdopter parseWriteDataWithCharacteristic:characteristic]];
}
...
- (void)dataParserReceivedData:(NSDictionary *)dataDic{
    ...
    mk_cp_taskOperationID operationID = [dataDic[@"operationID"] integerValue];
    if (operationID == mk_cp_defaultTaskOperationID || operationID != self.operationID) {
        return;
    }
...
//    if (operationID == mk_cp_taskReadHundredHistoryDataOperation) {
//        //历史数据是多包数据
